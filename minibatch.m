...
%randomly generate weight matrix with Xavier Glorot initilisation 
maxlimit = sqrt(6/5);
minlimit = - maxlimit;
...
%combine endpoint and training angles together
dataCombined(1:3,:) = x;
dataCombined(4:5,:) = training_data;
%calculate number of batches for given batch size
